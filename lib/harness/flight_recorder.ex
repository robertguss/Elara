defmodule Harness.FlightRecorder do
  ...
  def new(core, session_id, incarnation, session_path) do
    ...
    header = %{
      ...
      producer: %{
        harness_version: Application.spec(:harness, :vsn) |> to_string(),
  ...
  defp fingerprint(term) do
    :sha256
    |> :crypto.hash(:erlang.term_to_binary({:harness_flight, @version, term}, [:deterministic]))
