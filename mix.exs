...
defmodule Elara.MixProject do
  ...
  def project do
    [
      ...
      test_ignore_filters: [
        ~r"test/support/(context_restart|test_job_recovery_live|test_job_repository_live|edit_replace_all_live|live_session_driver|long_context_job_live|session_crash_job_live|concurrent_test_jobs|concurrent_test_jobs_live|fixtures/elixir_project_v1)\.exs$"
      ],
      deps: deps()
    ]
  end
