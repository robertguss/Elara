defmodule Elara.AuthTest do
  ...
  test "tokens_from_map prefers the elara client id over other issuers" do
  ...
  test "tokens_from_map still accepts flat elara files" do
