defmodule Elara.Chat.CoreTest do
  ...
  @rows [
    ...
    {:idle_why, :idle, {:line, "/why"}, :idle, [{:why, :latest}]},
    {:idle_why_event, :idle, {:line, "/why 7"}, :idle, [{:why, 7}]},
    {:idle_why_bad, :idle, {:line, "/why nope"}, :idle, [{:print, "usage: /why or /why N\n> "}]},
  ...
  test "reload results report empty, successful, and failed reloads" do
    info = %Elara.Plugin.Info{id: "counter", version: "2", generation: 3}
