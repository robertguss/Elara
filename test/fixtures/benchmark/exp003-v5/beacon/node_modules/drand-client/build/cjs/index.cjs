...
var require_bls = __commonJS({
  "node_modules/@noble/curves/abstract/bls.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.bls = bls2;
...
var require_tower = __commonJS({
  "node_modules/@noble/curves/abstract/tower.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.psiFrobenius = psiFrobenius2;
    exports2.tower12 = tower122;
...
var require_bn254 = __commonJS({
  "node_modules/@kevincharm/noble-bn254-drand/dist/src/bn254.js"(exports2) {
    "use strict";
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.bn254 = void 0;
    exports2.mapToCurveSVDW = mapToCurveSVDW;
    var utils_1 = require_utils();
    ...
    exports2.bn254 = (0, bls_1.bls)({
      ...
      G1: {
        ...
        fromBytes: (bytes) => {
          ...
          exports2.bn254.G1.ProjectivePoint.fromAffine(point).assertValidity();
          return point;
        },
        ...
        ShortSignature: {
          fromHex(hex) {
            return exports2.bn254.G1.ProjectivePoint.fromHex(hex);
          },
          toRawBytes(point) {
      ...
      G2: {
        ...
        fromBytes: (bytes) => {
          ...
          exports2.bn254.G2.ProjectivePoint.fromAffine({ x, y }).assertValidity();
          return { x, y };
        },
        toBytes: (c, point, _isCompressed) => {
          const { BYTES: len } = Fp3;
        ...
        Signature: {
          fromHex(hex) {
            return exports2.bn254.G2.ProjectivePoint.fromHex(hex);
          },
          toRawBytes(point) {
            return point.toRawBytes();
          },
...
var require_src = __commonJS({
  "node_modules/@kevincharm/noble-bn254-drand/dist/src/index.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    __exportStar(require_bn254(), exports2);
  }
});
...
__export(index_exports, {
  FastestNodeClient: () => fastest_node_client_default,
  HttpCachingChain: () => http_caching_chain_default,
  HttpChain: () => HttpChain,
  HttpChainClient: () => http_chain_client_default,
  MultiBeaconNode: () => multi_beacon_node_default,
  defaultChainOptions: () => defaultChainOptions,
  defaultClient: () => defaultClient,
  fetchBeacon: () => fetchBeacon,
  fetchBeaconByTime: () => fetchBeaconByTime,
  isBn254OnG1: () => isBn254OnG1,
  isChainedBeacon: () => isChainedBeacon,
  isG1G2SwappedBeacon: () => isG1G2SwappedBeacon,
  isG1Rfc9380: () => isG1Rfc9380,
  isUnchainedBeacon: () => isUnchainedBeacon,
  quicknetClient: () => quicknetClient,
  roundAt: () => roundAt,
  roundTime: () => roundTime,
  testnetDefaultClient: () => testnetDefaultClient,
  testnetQuicknetClient: () => testnetQuicknetClient,
  watch: () => watch
});
