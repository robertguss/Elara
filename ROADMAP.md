...
and inspected status once. Combined full suite: 530/530 passed. No runtime change.
...
**Previous integration:** DONE; merged and pushed to main in `306ca87`. Combined main `59aefa7`
...
JOB-4/JOB-5 IDs become JOB-8/JOB-9. JOB-6 and JOB-7 remain unchanged. The four incoming
...
Integration with published main `6c2765a` preserves the read/edit features and
all prior experiment histories. The conflicting JOB-6 label becomes JOB-10;
incoming JOB-6–JOB-9 retain their canonical IDs. The combined full suite passes
**530/530** in 135.3 seconds, with no discovery warnings. No live experiment was
rerun during integration; the captured run remains tied to `3da41ed`.
