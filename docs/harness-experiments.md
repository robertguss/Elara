...
Integration with published main `6c2765a` retained the incoming read/edit features
and reconciled this experiment to JOB-10. The combined tree passes **530/530 Mix
tests** in 135.3 seconds without support-discovery warnings. Existing source from
main was preserved unchanged; review confirmed unique IDs and retained histories.
The live run was not repeated during integration. The artifact's assistance text
was annotated after capture to distinguish fixture-entry markers from PID markers;
all measurements and transcripts are unchanged.
